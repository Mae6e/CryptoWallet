  ...
  web3.eth.getGasPrice()
    .then(gasPrice => {
      token.methods
        ...
        .then(estimatedGas => {
          const txPriceWei = estimatedGas * (gasPrice + web3.utils.toBigInt(exteraPrice));
          console.log(JSON.stringify(txPriceWei.toString()));
          process.exit(-1);
        });
    }).catch(error => {
      console.error(error);
